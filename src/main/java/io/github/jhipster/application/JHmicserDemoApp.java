...
public class JHmicserDemoApp {

    private static final Logger log = LoggerFactory.getLogger(JHmicserDemoApp.class);

    private final Environment env;

    public JHmicserDemoApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes JHmicserDemo.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JHmicserDemoApp.class);
