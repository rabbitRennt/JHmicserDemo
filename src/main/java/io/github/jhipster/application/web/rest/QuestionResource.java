...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.Question}.
 */
@RestController
@RequestMapping("/api")
public class QuestionResource {
  ...
  private static final String ENTITY_NAME = "jHmicserDemoQuestion";
  ...
  public ResponseEntity<Question> partialUpdateQuestion(
    ...
    log.debug(
      "REST request to partial update Question partially : {}, {}",
      id,
      question
    );
    if (question.getId() == null) {
